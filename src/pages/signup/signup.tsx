        ...
        <div className="flex-1 flex flex-col justify-center w-full max-w-sm mx-auto">
          ...
          <div className="mb-8">
            ...
            <input
              ...
              placeholder="User"
              className="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-sm text-gray-400 placeholder-gray-300 outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all"
            />
          </div>
          ...
          {/* CTA */}
          <button
            onClick={() => navigate("/profile-choose")}
